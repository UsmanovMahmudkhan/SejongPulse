  ...
  return (
    <div className="bg-surface font-body text-on-surface antialiased overflow-hidden min-h-screen relative flex flex-col">
      ...
      <header className="fixed top-0 w-full z-50 bg-white/70 backdrop-blur-xl shadow-[0_8px_32px_rgba(0,0,0,0.04)] flex justify-between items-center px-6 py-4">
        ...
        <div className="flex items-center gap-3">
          <Link href="/notifications" className="w-10 h-10 flex items-center justify-center rounded-full hover:bg-zinc-100/50 transition-colors">
            <span className="material-symbols-outlined text-zinc-500">notifications</span>
          </Link>
          <span className="text-xs font-bold text-slate-400 uppercase tracking-widest">
            {recommendations.length - currentIndex > 0 ? `${recommendations.length - currentIndex} left` : ""}
          </span>
      ...
      {showToast && (
        <div className="fixed top-24 left-1/2 -translate-x-1/2 z-[200] animate-fade-in-up">
          <div className="bg-emerald-500 text-white px-6 py-3 rounded-2xl shadow-xl font-black text-sm flex items-center gap-2">
            ...
            >
              ...
              <div className="relative w-full aspect-[3/4.5] rounded-[2.5rem] overflow-hidden shadow-[0px_40px_80px_rgba(0,0,0,0.12)] crimson-pulse-glow group bg-surface-container-low border border-outline-variant/20 flex flex-col justify-end">
                ...
                <div className="absolute top-6 right-6 z-20 opacity-50">
                  <p className="text-white text-[10px] font-bold uppercase tracking-widest">Swipe or tap</p>
                </div>
